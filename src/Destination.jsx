...
import muesuem from './assets/muesuem.png'
import beach from './assets/beachtours.png'
import cityTours from './assets/cityTours.png'
...
const Destination = () => {
  ...
  const tours = [
    ...
    // populartgings
  const thingsToDo = [
    { title: "Cruises", image: cruise, },
    { title: "Museum Tour", image: muesuem, },
    { title: "City Tours", image: beach, },
    { title: " Beach Tours", image: cityTours },
  ...
  return (
    <>
      ...
      <section className="px-6 mb-18 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Popular things to do</h2>
          <a href="#" className="text-sm text-gray-500 hover:underline">See all</a>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {thingsToDo.map((item, index) => (
            <ThingsToDoCard key={index} title={item.title} image={item.image} />
          ))}
        </div>
      </section>
